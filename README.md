...
The input consists of a triangulated surface model of the distal femur, the side of the femur and an initial transformation from the coordinate system of the medical imaging system into the default sagittal plane (DSP) (see Table 1). 
The XY-plane is the DSP due to the initial transformation of the bone surface into its centroid.<br/>

The initially transformed bone surface is passed to the main function that adheres closely to the framework proposed by Li et al. to calculate the unified sagittal plane (USP). 
